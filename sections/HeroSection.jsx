  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className="mt-4 inline-block px-4 py-2 font-bold font-montserrat text-[#DABF70] text-base md:text-lg bg-gradient-to-r from-red-600 to-transparent rounded-md"
