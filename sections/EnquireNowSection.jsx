...
import bgImage from "../assets/enquire.jpg"; // Replace with your background
  ...
  return (
    ...
    >
      <h1 className="sm:text-4xl text-xl font-bold text-[#DABF70] mb-6 leading-tight text-center sm:text-left">
        Your Dream Home Awaits! Fill The Form <br /> And Let Us Take Care Of The
        Rest.
      </h1>

      <div className="mx-auto h-full flex flex-col sm:flex-row">
        {/* Left Section: Form */}
        <div className="w-full sm:w-[50%] bg-[#A5384E] p-6 sm:p-8 rounded-4xl shadow-lg">
          ...
          <form className="space-y-4 flex flex-col gap-2">
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                className="w-full px-4 py-2 border bg-white rounded-md focus:outline-none focus:ring-2 h-[61px]"
              />
              <input
                type="email"
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-2 border bg-white rounded-md focus:outline-none focus:ring-2"
            ></textarea>
            <button
              type="submit"
              className="bg-white hover:bg-[#852438] hover:text-white px-6 py-2 w-[241px] h-[50px] rounded-4xl transition mx-auto sm:mx-0"
            >
