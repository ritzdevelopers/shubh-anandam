...
//     <section
//       id="contact"
//       className="w-full h-[90vh] px-4 sm:px-[86px] flex items-center justify-center relative"
//       style={{
...
//               <button
//                 type="submit"
//                 className="hover:bg-[#DABF70] bg-[#852438] text-white px-6 py-2 w-[241px] h-[50px] rounded-4xl transition mx-auto cursor-pointer"
//               >
...
export default function EnquireSection() {
  return (
    <Parallax
      bgImage={bgImage.src}
      strength={300} // Adjust parallax depth here
