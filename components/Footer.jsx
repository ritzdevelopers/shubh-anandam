...
//     <footer
//       id="footer"
//       className="relative h-[450px] px-[86px] bg-cover bg-center text-white flex flex-col justify-between"
...
//         <div className="container flex flex-col md:flex-row flex-wrap justify-between items-start gap-8">
//           {/* Logo + Social Links */}
//           <div className="flex flex-col items-start">
//             <img src={logoImage.src} alt="Logo" className="  mb-4" />
...
export default function Footer() {
  return (
    ...
    >
      ...
      {/* Footer Bottom */}
      <div className="relative z-10 bg-[#41000A] bg-opacity-80 text-[#DABF70CC] text-center text-sm py-4">
        <p>
          &copy; Shubh Anandam Pvt Ltd 2025. | All Rights Reserved | Developed
          by ritzmediaworld.com
        </p>
